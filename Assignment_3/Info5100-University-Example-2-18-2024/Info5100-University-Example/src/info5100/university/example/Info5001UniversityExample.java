...
//      Create teacher for class
        ...
        Person person1 = persondirectory.newPerson("Ashton"); 
        Person person2 = persondirectory.newPerson("Ryan"); 
        Person person3 = persondirectory.newPerson("Pamela"); 
        Person person4 = persondirectory.newPerson("Ziyang"); 
        Person person5 = persondirectory.newPerson("Jia"); 
        Person person6 = persondirectory.newPerson("Mark"); 
        Person person7 = persondirectory.newPerson("Marcus"); 
        Person person8 = persondirectory.newPerson("xin");
        ...
        //System.out.println(courseload1.getSemesterScore());
        ...
        for (StudentProfile sp : department.getStudentDirectory().getAllStudents()){
            ...
            for (SeatAssignment sa : seatassignments){
                System.out.println("Student Name: " + sp.getID() 
                        + " Teacher: " + sa.getCourseOffer().getFacultyProfile().getID()
                        + " Course: " + sa.getAssociatedCourse().getName() 
                        + " Grade: " + sa.getG() 
                        + " GPA: " + sa.GetCourseStudentScore() / sa.getCreditHours() 
                        + " Tuition: $" + sa.getAssociatedCourse().getCoursePrice());
            }
        }
